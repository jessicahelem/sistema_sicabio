...
class Paciente(models.Model):
    ...
    foto = models.ImageField(upload_to='pacientes', null=True, default='avatar.png')
    ...
    profissional = models.ForeignKey('Profissional',on_delete=models.CASCADE,null=True,default=True)
